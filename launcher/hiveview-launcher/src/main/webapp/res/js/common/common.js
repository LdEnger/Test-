    ...
    $('#content'+contentType).bootstrapTable({
        ...
        onClickRow: function(row) {
            ...
            if(contentType == 1){
                ...
                if("com.hiveview.premiere" ==row.apkBagName && preM3u8 !=null && preM3u8!=''){
                    $("#txt_isPlay").val(1);
                }else{
                    $("#txt_isPlay").val(0);
                }
            ...
            if(contentType == 0){
                ...
                if(row.subjectVerPic == null){
                    $('#recommendContentImg').attr('src', '');
                }else{
                    $('#recommendContentImg').attr('src', row.subjectVerPic);
                }
                $('#back_templet_id').val(row.templeteId);
                $('#back_templet_apk').val(row.apkBagName);
                $('#back_templet_channel_type').val('');
            ...
            if(contentType == 8){
                //暂且默认赋值1
                $('#editcontent_id').val(1);
                $('#txt_contentname').val(row.name);
                $('#txt_title').val(row.name);
                $('#recommendContentImg').attr('src', row.imgUrl);
                $('#back_templet_id').val('');
                $('#back_templet_apk').val('');
                $('#back_templet_channel_type').val('');
                $('#back_templet_channel').val('');
...
function dataSource(){
    ...
    if(contentType == 8){
        ...
        $('#div_'+11).css('display','none');
        $('#div_'+12).css('display','none');
        getMoreList(8,"/portal/youGouSpecials/getPageList");
    }
    //优购详情
    if(contentType == 9){
        moreparam ={};
        //moreparam['tabName'] =$("#name_9").val();暂定
        $('#div_'+0).css('display','none');
        $('#div_'+1).css('display','none');
        $('#div_'+2).css('display','none');
        $('#div_'+3).css('display','none');
        ...
        $('#div_'+11).css('display','none');
        $('#div_'+12).css('display','none');
        getMoreList(9,"/portal/youGouGoods/getPageList");
    }
    //tab
    if(contentType == 10){
        moreparam ={};
        moreparam['tabName'] =$("#name_10").val();
        $('#div_'+0).css('display','none');
        $('#div_'+1).css('display','none');
        $('#div_'+2).css('display','none');
        $('#div_'+3).css('display','none');
        ...
        $('#div_'+11).css('display','none');
        $('#div_'+12).css('display','none');
        getMoreList(10,"/tab/getPageList");
    }
    //会员活动
    if(contentType == 11){
        moreparam ={};
        ...
        $('#div_'+12).css('display','none');
        getMoreList(11,"/activity/getPageList");
    }
    //启动应用(豆腐块)
    if(contentType == 12){
        moreparam ={};
        ...
        getMoreList(12,"/PortalNotStartInstruction/getPage");
    }
