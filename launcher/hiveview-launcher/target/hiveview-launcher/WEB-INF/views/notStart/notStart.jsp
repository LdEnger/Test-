...
<script src="${ctx}/res/js/notStart/notStart.js" type="text/javascript"></script>
                ...
                <div class="portlet-body ">
                    <div class="clearfix" style="position: relative;top:4px;">
                        <div class="btn-group">
                            ...
                            <label style="display: inline-block;padding-left: 25px;" for="start_name">
                                启动名称：
                            </label>
                            <input type="text" style="margin-left: 5px;" id="start_name">
                            <label style="display: inline-block;padding-top: 5px;" for="txt_start_effective">
                                <span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上下线：</span></label>
                            <select class="form-control selectpicker" data-mobile="true" name="txt_start_effective" id="txt_start_effective" style="margin-top: 5px;width: 64px;">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="myModalLabel">定制APK启动指令管理</h4>
            </div>
            <div class="modal-body">
                <input id="txt_notStartInstructionId" type="hidden">
                <div class="form-group">
                    <label for="txt_AppName" style="display: inline-block;margin-right: -12px;">启动名称：</label>
                ...
                <div class="form-group">
                    <label for="txt_startApk" style="display: inline-block;margin-right: 0px;">启动APK：</label>
                ...
                <div class="form-group">
                    <label for="txt_actionStr" style="display: inline-block;margin-right: -37px;">Action指令：</label>
                    <input type="text" name="txt_actionStr" class="form-control" id="txt_actionStr" placeholder="字符串" style="vertical-align: -1px;margin-left: 46px;">
                </div>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-default" onclick="startInstruction_submit();">保存</button>
                <button type="button" class="btn btn-default" onclick="clear_diaglog1();">取消</button>
            </div>
        </div><!-- /.modal-content -->
    </div><!-- /.modal -->
</div>