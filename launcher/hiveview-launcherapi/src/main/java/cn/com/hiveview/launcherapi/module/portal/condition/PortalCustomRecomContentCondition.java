...
@Data
public class PortalCustomRecomContentCondition extends BaseCondition implements Serializable {
    ...
    private Integer layoutTeamIndex;
    private Integer layoutTeamSize;
